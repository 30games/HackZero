...
program_menu.add_command(label="EditZero", command=lambda:MeF.EditZeroService())
...
program_menu.add_command(label="Incognito Browser", command=lambda:MeF.BrowseZeroService())
...
context_menu.add_command(label="", command=None)
context_menu.add_command(label="None3", command=None)
